{{--
  =====================================================================
   GABARIT COMMUN
  =====================================================================
   UNE SEULE RÈGLE GOUVERNE CE FICHIER : la page doit s'afficher en une
   requête, sur un téléphone d'entrée de gamme, en 2G.

   Conséquences concrètes, toutes délibérées :
     · le CSS est EN LIGNE, pas dans un fichier séparé. Un fichier
       externe coûte un aller-retour réseau supplémentaire — sur une
       liaison à 300 ms de latence, c'est une demi-seconde perdue avant
       le premier pixel. À cette taille (moins de 4 Ko), l'inclure coûte
       moins cher que le mettre en cache.
     · AUCUN JavaScript. Pas de framework, pas de bundle. Rien à
       télécharger, rien à exécuter, rien à faire échouer.
     · aucune police distante. Les polices système s'affichent
       instantanément et ne coûtent aucun octet.
  ===================================================================== --}}
<!DOCTYPE html>
<html lang="fr">
<head>
...
<title>@yield('titre', 'Afrishop')</title>
<style>
:root{
...
<header>
  <div class="wrap bar">
    ...
    <nav style="display:flex;gap:16px">
      ...
      <a href="{{ url('/api/categories') }}">API</a>
    </nav>
  </div>
</header>
